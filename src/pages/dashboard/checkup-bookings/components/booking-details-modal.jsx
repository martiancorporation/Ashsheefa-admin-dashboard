...
// Same label/value field the appointment details modal uses, so the two
        ...
        <div className="space-y-3 pb-1">
          ...
          <div className="rounded-xl border border-gray-100 bg-gray-50 p-4">
            <div className="flex items-center justify-between mb-4">
              ...
              >
                {booking.checkup_status || "Not set"}
              </Badge>
            </div>
          ...
          <div className="rounded-xl border border-blue-100 bg-blue-50 p-4">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4">
              ...
              <InfoRow
                label="Package"
                value={booking.checkup_name || checkup?.checkup_name}
                icon={FlaskConical}
              />
              <InfoRow
              ...
              <InfoRow label="Package Price">
                <span className="text-sm text-gray-800 font-medium flex items-center gap-1">
                  ...
                  {Number(booking.package_price || 0).toLocaleString("en-IN")}
                </span>
              </InfoRow>
              ...
              {/* Mode and reference live in the Payment Details modal, same as
                  appointments — they'd be stale or empty for an unpaid booking. */}
            ...
            <div className="rounded-xl border border-gray-100 bg-gray-50 p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5">
                {tests.map((t, i) => (
                  <div
                    key={i}
                    className="text-sm text-gray-700 bg-white border border-gray-100 rounded px-2.5 py-1.5"
                  >
                    {t}
                  </div>
                ))}
