...
export function UpdateStatusModal({ open, onOpenChange, patient: patientData, onSave }) {
    ...
    React.useEffect(() => {
        if (open && patientData) {
            setSelectedStatus(patientData.status || "")
        }
    }, [open, patientData])
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await patient.updatePatient(patientData._id, updateData)
                    ...
                    {patientData && (
                        <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="text-sm text-gray-600">
                                ...
                                <p><strong>Department:</strong> {patientData.speciality || "Not Specified"}</p>
                                <p><strong>Current Status:</strong> {patientData.status || "Not set"}</p>
                            </div>
                        </div>
                    )}
