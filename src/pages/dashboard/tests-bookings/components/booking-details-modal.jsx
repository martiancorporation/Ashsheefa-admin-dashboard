    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
          ...
          <div>
            <h4 className="text-sm font-semibold text-gray-700 mb-1 mt-2">Tests</h4>
            <Row label="Tests Booked" value={booking.tests_count ?? tests.length} />
            <Row
              label="Collection"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
          ...
          <div>
            ...
            <Row label="Tests Total" value={`₹ ${Number(booking.tests_total || 0)}`} />
            <Row
          ...
          <div className="mt-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5">
              {tests.map((t, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between gap-2 text-sm text-gray-600 bg-gray-50 rounded px-2.5 py-1.5"
                >
