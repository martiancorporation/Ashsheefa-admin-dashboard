...
import { exportTestBookingsToExcel } from "./components/export-test-bookings";
...
export default function TestsBookingsPage() {
  ...
  const handleExportToExcel = async () => {
    ...
    try {
      setExporting(true);
      await exportTestBookingsToExcel(visibleBookings);
      toast.success(
        `Exported ${visibleBookings.length} test booking${
